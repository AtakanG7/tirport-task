...
const follow_entity_1 = require("./entities/user.entity/follow.entity");
const carriers_entity_1 = require("../carriers/entities/carriers.entity/carriers.entity");
let UsersService = class UsersService {
    constructor(userRepository, followRepository, carrierRepository) {
    ...
    async getFavoriteCarriers(user_id) {
...
exports.UsersService = UsersService = __decorate([
    ...
    __param(2, (0, typeorm_1.InjectRepository)(carriers_entity_1.Carrier)),
